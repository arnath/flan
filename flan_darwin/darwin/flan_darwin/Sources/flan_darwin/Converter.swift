...
public class Converter {
    ...
    public static func notificationSettingsToMap(_ settings: UNNotificationSettings) -> [String:
        String]
    {
        let output: [String: String] = [
            "authorizationStatus": authorizationStatusToString(settings.authorizationStatus),
            "notificationCenterSetting": notificationSettingToString(
            ...
            "scheduledDeliverySetting": notificationSettingToString(
